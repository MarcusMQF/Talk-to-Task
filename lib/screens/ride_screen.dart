...
class _RideScreenState extends State<RideScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Initialize location first before anything else
    _initializeLocation().then((_) {
      if (mounted) {
        ...
        // Setup location updates only after initial location is obtained
    ...
    // Ensure weather data is fetched early
    _deviceInfo.fetchWeatherData().then((_) {
      if (mounted) {
        print("Initial weather fetch complete");
      }
    });
